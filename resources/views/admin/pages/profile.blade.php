            ...
            <div class="flex items-center justify-between w-full px-6 py-1 mx-auto flex-wrap-inherit">
                <nav>
                    ...
                    <ol class="flex flex-wrap pt-1 pl-2 pr-4 mr-12 bg-transparent rounded-lg sm:mr-16">
                        ...
                        <li class="text-size-sm pl-2 capitalize leading-normal before:float-left before:pr-2 before:content-['/']"
                ...
                <div class="w-full max-w-full px-3 xl:w-4/12">
                    <div
                        ...
                        <label for=" follow"
                            ...
                            <h6 class="mt-6 font-bold leading-tight uppercase text-size-xs text-slate-500">Application
                            </h6>
                            <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                                <li class="relative block px-0 py-2 bg-white border-0 rounded-t-lg text-inherit">
                                    <div class="min-h-6 mb-0.5 block pl-0">
                    ...
                    <div
                        ...
                        <div class="flex-auto p-4">
                            <p class="leading-normal text-size-sm">Hi, I’m Alec Thompson, Decisions: If you can’t
                                decide, the answer
                                is no. If two equally difficult paths, choose the one more painful in the short term
                                (pain avoidance is
                                ...
                                <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
                                    <div
                                        ...
                                        <div class="flex-auto px-1 pt-6">
                                            ...
                                            <p class="mb-6 leading-normal text-size-sm">As Uber works through a huge
                                                amount of internal
                                ...
                                <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
                                    <div
                                        ...
                                        <div class="flex-auto px-1 pt-6">
                                            ...
                                            <p class="mb-6 leading-normal text-size-sm">Music is something that every
                                                person has his or her
                                                own specific opinion about.</p>
                                            <div class="flex items-center justify-between">
                                                <button type="button"
                                                    class="inline-block px-8 py-2 mb-0 font-bold text-center uppercase align-middle transition-all bg-transparent border border-solid rounded-lg shadow-none cursor-pointer leading-pro ease-soft-in text-size-xs hover:scale-102 active:shadow-soft-xs tracking-tight-soft border-fuchsia-500 text-fuchsia-500 hover:border-fuchsia-500 hover:bg-transparent hover:text-fuchsia-500 hover:opacity-75 hover:shadow-none active:bg-fuchsia-500 active:text-white active:hover:bg-transparent active:hover:text-fuchsia-500">View
                                                    Project</button>
                                ...
                                <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
                                    <div
                                        ...
                                        <div class="flex-auto px-1 pt-6">
                                            ...
                                            <p class="mb-6 leading-normal text-size-sm">Different people have different
                                                taste, and various
                                                types of music.</p>
                                            <div class="flex items-center justify-between">
                                                <button type="button"
