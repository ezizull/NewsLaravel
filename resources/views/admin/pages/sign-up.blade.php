...
<body class="m-0 font-sans antialiased font-normal bg-white text-start text-size-base leading-default text-slate-500">
    ...
    <nav
        ...
        <div class="container flex items-center justify-between py-0 flex-wrap-inherit">
            <a class="py-2.375 text-size-sm mr-4 ml-4 whitespace-nowrap font-bold text-white lg:ml-0"
            ...
            <div navbar-menu
                ...
                <ul class="flex flex-col pl-0 mx-auto mb-0 list-none lg:flex-row xl:ml-auto">
                    <li>
                        <a class="flex items-center px-4 py-2 mr-2 font-normal text-white transition-all duration-250 lg-max:opacity-0 lg-max:text-slate-700 ease-soft-in-out text-size-sm lg:px-2 lg:hover:text-white/75"
                ...
                <ul class="hidden pl-0 mb-0 list-none lg:block lg:flex-row">
                    <li>
                        <a href="https://www.creative-tim.com/product/soft-ui-dashboard-tailwind" target="_blank"
                            class="leading-pro hover:scale-102 hover:shadow-soft-xs active:opacity-85 ease-soft-in text-size-xs tracking-tight-soft shadow-soft-md bg-gradient-gray rounded-3.5xl mb-0 mr-1 inline-block cursor-pointer border-0 bg-transparent px-8 py-2 text-center align-middle font-bold uppercase text-slate-800 transition-all">Free
                            download</a>
                    </li>
                </ul>
            </div>
                            ...
                            <div class="flex-auto p-6">
                                <form role="form text-left">
                                    ...
                                    <p class="mt-4 mb-0 leading-normal text-size-sm">Already have an account? <a
                                            href="{{ route('signin') }}" class="font-bold text-slate-700">Sign in</a>
                                    </p>
                                </form>
                            </div>
                        </div>
