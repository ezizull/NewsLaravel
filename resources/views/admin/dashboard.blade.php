                    ...
                    <div
                        ...
                        <div class="flex-auto p-4">
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        <p class="mb-0 font-sans font-semibold leading-normal text-size-sm">New Clients
                                        </p>
                                        <h5 class="mb-0 font-bold">
                                            +3,462
                                            <span
                ...
                <div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-5/12 lg:flex-none">
                    <div
                        ...
                        <div class="flex-auto p-4">
                            ...
                            <p class="ml-2 leading-normal text-size-sm">(<span class="font-bold">+23%</span>) than last
                                week</p>
                                            ...
                                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                                <div class="mt-2 avatar-group">
                                                    <a href="javascript:;"
                                                        ...
                                                        <img src="{{ asset('admin/img/team-1.jpg') }}"
                                                    ...
                                                    <a href="javascript:;"
                                                        class="relative z-20 inline-flex items-center justify-center w-6 h-6 -ml-4 text-white transition-all duration-200 border-2 border-white border-solid rounded-full ease-soft-in-out text-size-xs hover:z-30"
                                                        data-target="tooltip_trigger" data-placement="bottom">
                                                        <img src="{{ asset('admin/img/team-3.jpg') }}"
                                                            class="w-full rounded-full"
                                                            alt="team3" />
                                                    </a>
                                                    <div data-target="tooltip"
                                                    ...
                                                    <a href="javascript:;"
                                                        class="relative z-20 inline-flex items-center justify-center w-6 h-6 -ml-4 text-white transition-all duration-200 border-2 border-white border-solid rounded-full ease-soft-in-out text-size-xs hover:z-30"
                                                        data-target="tooltip_trigger" data-placement="bottom">
                                                        <img src="{{ asset('admin/img/team-4.jpg') }}"
                                                            class="w-full rounded-full"
                                                            alt="team4" />
                                                    </a>
                                                    <div data-target="tooltip"
                                        ...
                                        <tr>
                                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                                <div class="flex px-2 py-1">
                                                    ...
                                                    <div class="flex flex-col justify-center">
                                                        <h6 class="mb-0 leading-normal text-size-sm">Launch our Mobile
                                                            App</h6>
                                                    </div>
                                                </div>
                                            </td>
                        ...
                        <div class="flex-auto p-4">
                            <div
                                ...
                                <div class="relative mb-4 mt-0 after:clear-both after:table after:content-['']">
                                    ...
                                    <div class="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                                        <h6 class="mb-0 font-semibold leading-normal text-size-sm text-slate-700">$2400,
                                            Design changes</h6>
                                        <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs text-slate-400">22
                                            DEC 7:20 PM</p>
                                    </div>
                                </div>
                                <div class="relative mb-4 after:clear-both after:table after:content-['']">
                                    ...
                                    <div class="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                                        <h6 class="mb-0 font-semibold leading-normal text-size-sm text-slate-700">New
                                            order #1832412</h6>
                                        <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs text-slate-400">21
                                            DEC 11 PM</p>
                                    </div>
                                </div>
                                <div class="relative mb-4 after:clear-both after:table after:content-['']">
                                ...
                                <div class="relative mb-4 after:clear-both after:table after:content-['']">
                                    ...
                                    <div class="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                                        ...
                                        <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs text-slate-400">20
                                            DEC 2:20 AM</p>
                                    </div>
                                </div>
                                <div class="relative mb-4 after:clear-both after:table after:content-['']">
                                    ...
                                    <div class="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                                        ...
                                        <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs text-slate-400">18
                                            DEC 4:54 AM</p>
                                    </div>
                                </div>
                                <div class="relative mb-0 after:clear-both after:table after:content-['']">
                                    ...
                                    <div class="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                                        <h6 class="mb-0 font-semibold leading-normal text-size-sm text-slate-700">New
                                            order #9583120</h6>
                                        <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs text-slate-400">17
                                            DEC</p>
                                    </div>
                                </div>
                            </div>
