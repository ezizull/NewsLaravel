<aside
    ...
    <div class="h-19.5">
        <i class="absolute top-0 right-0 hidden p-4 opacity-50 cursor-pointer fas fa-times text-slate-400 xl:hidden"
            sidenav-close></i>
        <a class="block px-8 py-6 m-0 text-size-sm whitespace-nowrap text-slate-700" href="{{ route('admin') }}">
            <img src="{{ asset('admin/img/logo-ct.png') }}"
                ...
                <a class="py-2.7 shadow-soft-xl text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors"
                    ...
                    <div
                        ...
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                            ...
                            <title>shop</title>
                            <g stroke="none" stroke-width="1" class="fill-white" fill-rule="evenodd">
                ...
                <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                    ...
                    <div
                        ...
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>shop</title>
                            <g stroke="none" stroke-width="1" class="fill-slate-800" fill-rule="evenodd">
                                <g transform="translate(-1716.000000, -439.000000)"
                                    fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                                        <g transform="translate(0.000000, 148.000000)">
                ...
                <a class="py-2.7 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                    ...
                    <div
                        ...
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" class="fill-slate-800" fill-rule="evenodd">
                                <g transform="translate(-1869.000000, -293.000000)"
                                    fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
                                        <g transform="translate(153.000000, 2.000000)">
    ...
    <div class="mx-4">
        ...
        <p
            class="invisible hidden text-gray-800 after:bg-gradient-dark-gray">
        </p>
        <div class="after:opacity-65 after:bg-gradient-slate relative flex min-w-0 flex-col items-center break-words rounded-2xl border-0 border-solid border-blue-900 bg-white bg-clip-border shadow-none after:absolute after:top-0 after:bottom-0 after:left-0 after:z-10 after:block after:h-full after:w-full after:rounded-2xl after:content-['']"
            ...
            <div class="mb-7.5 absolute h-full w-full rounded-2xl bg-cover bg-center"
                style="background-image: {{ url('admin/img/curved-images/white-curved.jpeg') }}"></div>
